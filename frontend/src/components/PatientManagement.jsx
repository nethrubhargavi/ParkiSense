  ...
  const handleAddPatient = async (e) => {
    ...
    try {
      ...
      if (data.status === 'success') {
        ...
        setFormData({ firstName: '', lastName: '', dateOfBirth: '', mrnNumber: '', email: '', notes: '' })
          ...
          <form onSubmit={handleAddPatient} className="add-patient-form">
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <input type="text" value={formData.mrnNumber}
                  onChange={(e) => setFormData({ ...formData, mrnNumber: e.target.value })}
                  placeholder="e.g., MRN123456" disabled={isLoading} />
              </div>
            </div>
            <div className="form-row">
              <div className="form-group full-width">
                ...
                <input type="email" value={formData.email}
                  ...
                  placeholder="patient@example.com" disabled={isLoading} />
              </div>
            </div>
            <div className="form-row">
              <div className="form-group full-width">
      ...
      <div className="patients-section">
        ...
        {filteredPatients.length === 0 ? (
          <div className="empty-state">
            ...
            {patients.length === 0 && <p className="note">Click "Add New Patient" to get started</p>}
          </div>
        ) : (
            ...
            {filteredPatients.map((patient) => (
              ...
              >
                ...
                <div className="patient-card-content">
                  ...
                  {patient.notes && <p className="notes"><strong>Notes:</strong> {patient.notes.substring(0, 100)}...</p>}
                </div>
                <div className="patient-card-actions">
                  <button onClick={(e) => { e.stopPropagation(); onStartAssessment && onStartAssessment(patient) }}
                    className="btn btn-small btn-primary">
                    📋 Run Assessment
                  </button>
                  <button onClick={(e) => { e.stopPropagation(); handleDeletePatient(patient.id) }}
      ...
      {selectedPatient && (
        <div className="patient-detail-panel">
          ...
          <div className="detail-content">
            ...
            {selectedPatient.notes && <p><strong>Notes:</strong> <br/>{selectedPatient.notes}</p>}
            {selectedPatient.createdAt && <p><strong>Added:</strong> {new Date(selectedPatient.createdAt).toLocaleDateString()}</p>}
          </div>
